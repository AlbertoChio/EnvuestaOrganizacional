...
public class X.innodbBufferStatsBySchemaId  implements java.io.Serializable {
    ...
    public X.innodbBufferStatsBySchemaId(long pages, long pagesHashed, long pagesOld, BigDecimal rowsCached) {
        this.pages = pages;
        this.pagesHashed = pagesHashed;
        this.pagesOld = pagesOld;
        this.rowsCached = rowsCached;
    }
    public X.innodbBufferStatsBySchemaId(String objectSchema, BigDecimal allocated, BigDecimal data, long pages, long pagesHashed, long pagesOld, BigDecimal rowsCached) {
