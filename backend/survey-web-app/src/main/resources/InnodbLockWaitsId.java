...
public class InnodbLockWaitsId implements java.io.Serializable {
	...
	public InnodbLockWaitsId(String lockedType, String waitingTrxId, Date waitingTrxStarted, long waitingTrxRowsLocked,
			long waitingTrxRowsModified, long waitingPid, String waitingLockId, String waitingLockMode,
			String blockingTrxId, long blockingPid, String blockingLockId, String blockingLockMode,
	...
	public InnodbLockWaitsId(Date waitStarted, Date waitAge, Long waitAgeSecs, String lockedTable,
			...
			String lockedTableSubpartition, String lockedIndex, String lockedType, String waitingTrxId,
			Date waitingTrxStarted, Date waitingTrxAge, long waitingTrxRowsLocked, long waitingTrxRowsModified,
			long waitingPid, String waitingQuery, String waitingLockId, String waitingLockMode, String blockingTrxId,
	...
	@Column(name = "sql_kill_blocking_query", nullable = false, length = 32)
	...
	@Column(name = "sql_kill_blocking_connection", nullable = false, length = 26)
	...
	public boolean equals(Object other) {
		...
		return ((this.getWaitStarted() == castOther.getWaitStarted()) || (this.getWaitStarted() != null
				...
				&& ((this.getWaitingTrxId() == castOther.getWaitingTrxId())
						|| (this.getWaitingTrxId() != null && castOther.getWaitingTrxId() != null
								&& this.getWaitingTrxId().equals(castOther.getWaitingTrxId())))
				...
				&& ((this.getBlockingTrxId() == castOther.getBlockingTrxId())
						|| (this.getBlockingTrxId() != null && castOther.getBlockingTrxId() != null
								&& this.getBlockingTrxId().equals(castOther.getBlockingTrxId())))
