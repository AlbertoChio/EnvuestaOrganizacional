...
public class X.hostSummaryByStatementLatencyId  implements java.io.Serializable {
    ...
    public X.hostSummaryByStatementLatencyId(String host, BigDecimal total, BigDecimal totalLatency, Long maxLatency, BigDecimal lockLatency, BigDecimal rowsSent, BigDecimal rowsExamined, BigDecimal rowsAffected, BigDecimal fullScans) {
       this.host = host;
       this.total = total;
