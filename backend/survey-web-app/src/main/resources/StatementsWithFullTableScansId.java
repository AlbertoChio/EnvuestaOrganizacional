...
public class StatementsWithFullTableScansId implements java.io.Serializable {
	...
	public StatementsWithFullTableScansId(long execCount, long noIndexUsedCount, long noGoodIndexUsedCount,
			BigDecimal noIndexUsedPct, long rowsSent, long rowsExamined, Date firstSeen, Date lastSeen) {
	...
	public StatementsWithFullTableScansId(String query, String db, long execCount, String totalLatency,
			long noIndexUsedCount, long noGoodIndexUsedCount, BigDecimal noIndexUsedPct, long rowsSent,
			long rowsExamined, BigDecimal rowsSentAvg, BigDecimal rowsExaminedAvg, Date firstSeen, Date lastSeen,
			String digest) {
		this.query = query;
		this.db = db;
		this.execCount = execCount;
