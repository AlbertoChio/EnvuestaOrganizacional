...
public class X.statementsWithSortingId  implements java.io.Serializable {
    ...
    public X.statementsWithSortingId(long execCount, long totalLatency, long sortMergePasses, BigDecimal avgSortMerges, long sortsUsingScans, long sortUsingRange, long rowsSorted, BigDecimal avgRowsSorted, Date firstSeen, Date lastSeen) {
    ...
    public X.statementsWithSortingId(String query, String db, long execCount, long totalLatency, long sortMergePasses, BigDecimal avgSortMerges, long sortsUsingScans, long sortUsingRange, long rowsSorted, BigDecimal avgRowsSorted, Date firstSeen, Date lastSeen, String digest) {
       this.query = query;
       this.db = db;
       this.execCount = execCount;
       this.totalLatency = totalLatency;
