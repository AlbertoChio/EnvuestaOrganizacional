...
public class Session implements java.io.Serializable {
	...
	@AttributeOverrides({ @AttributeOverride(name = "thdId", column = @Column(name = "thd_id", nullable = false)),
			...
			@AttributeOverride(name = "lastStatementLatency", column = @Column(name = "last_statement_latency", length = 65535)),
			...
			@AttributeOverride(name = "lastWaitLatency", column = @Column(name = "last_wait_latency", length = 65535)),
			@AttributeOverride(name = "source", column = @Column(name = "source", length = 64)),
			@AttributeOverride(name = "trxLatency", column = @Column(name = "trx_latency", length = 65535)),
