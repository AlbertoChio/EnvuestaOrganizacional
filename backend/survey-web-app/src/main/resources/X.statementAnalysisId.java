...
public class X.statementAnalysisId  implements java.io.Serializable {
    ...
    public X.statementAnalysisId(String fullScan, long execCount, long errCount, long warnCount, long totalLatency, long maxLatency, long avgLatency, long lockLatency, long rowsSent, BigDecimal rowsSentAvg, long rowsExamined, BigDecimal rowsExaminedAvg, long rowsAffected, BigDecimal rowsAffectedAvg, long tmpTables, long tmpDiskTables, long rowsSorted, long sortMergePasses, Date firstSeen, Date lastSeen) {
