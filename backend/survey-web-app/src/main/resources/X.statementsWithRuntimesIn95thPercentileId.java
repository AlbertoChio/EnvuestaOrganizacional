...
public class X.statementsWithRuntimesIn95thPercentileId  implements java.io.Serializable {
    ...
    public X.statementsWithRuntimesIn95thPercentileId(String fullScan, long execCount, long errCount, long warnCount, long totalLatency, long maxLatency, long avgLatency, long rowsSent, BigDecimal rowsSentAvg, long rowsExamined, BigDecimal rowsExaminedAvg, Date firstSeen, Date lastSeen) {
    ...
    public X.statementsWithRuntimesIn95thPercentileId(String query, String db, String fullScan, long execCount, long errCount, long warnCount, long totalLatency, long maxLatency, long avgLatency, long rowsSent, BigDecimal rowsSentAvg, long rowsExamined, BigDecimal rowsExaminedAvg, Date firstSeen, Date lastSeen, String digest) {
       this.query = query;
       this.db = db;
       this.fullScan = fullScan;
       this.execCount = execCount;
