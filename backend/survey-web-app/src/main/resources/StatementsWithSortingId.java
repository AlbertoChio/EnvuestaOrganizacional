...
public class StatementsWithSortingId implements java.io.Serializable {
	...
	public StatementsWithSortingId(long execCount, long sortMergePasses, BigDecimal avgSortMerges, long sortsUsingScans,
			long sortUsingRange, long rowsSorted, BigDecimal avgRowsSorted, Date firstSeen, Date lastSeen) {
	...
	public StatementsWithSortingId(String query, String db, long execCount, String totalLatency, long sortMergePasses,
			BigDecimal avgSortMerges, long sortsUsingScans, long sortUsingRange, long rowsSorted,
			BigDecimal avgRowsSorted, Date firstSeen, Date lastSeen, String digest) {
		this.query = query;
		this.db = db;
		this.execCount = execCount;
