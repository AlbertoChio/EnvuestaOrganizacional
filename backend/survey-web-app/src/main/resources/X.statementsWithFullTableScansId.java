...
public class X.statementsWithFullTableScansId  implements java.io.Serializable {
    ...
    public X.statementsWithFullTableScansId(long execCount, long totalLatency, long noIndexUsedCount, long noGoodIndexUsedCount, BigDecimal noIndexUsedPct, long rowsSent, long rowsExamined, Date firstSeen, Date lastSeen) {
    ...
    public X.statementsWithFullTableScansId(String query, String db, long execCount, long totalLatency, long noIndexUsedCount, long noGoodIndexUsedCount, BigDecimal noIndexUsedPct, long rowsSent, long rowsExamined, BigDecimal rowsSentAvg, BigDecimal rowsExaminedAvg, Date firstSeen, Date lastSeen, String digest) {
       this.query = query;
       this.db = db;
       this.execCount = execCount;
       this.totalLatency = totalLatency;
