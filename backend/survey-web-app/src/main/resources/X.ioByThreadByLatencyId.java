...
public class X.ioByThreadByLatencyId  implements java.io.Serializable {
    ...
    public X.ioByThreadByLatencyId(String user, BigDecimal total, BigDecimal totalLatency, Long minLatency, BigDecimal avgLatency, Long maxLatency, long threadId, Long processlistId) {
       this.user = user;
       this.total = total;
