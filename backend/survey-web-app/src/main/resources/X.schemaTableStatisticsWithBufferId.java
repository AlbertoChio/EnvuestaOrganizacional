...
public class X.schemaTableStatisticsWithBufferId  implements java.io.Serializable {
    ...
    @Column(name="innodb_buffer_allocated", precision=43, scale=0)
    ...
    @Column(name="innodb_buffer_data", precision=43, scale=0)
    ...
    @Column(name="innodb_buffer_free", precision=44, scale=0)
